...
function sum(a, b) { //eslint-disable-line
  ...
  answer1.push(a + b);
  answer1.push('The sum of ' + a + ' and ' + b + ' is ' + answer1[0] + '.');
...
function multiply(a, b) { //eslint-disable-line
  ...
  answer2.push(a * b);
  answer2.push('The product of ' + a + ' and ' + b + ' is ' + answer2[0] + '.');
...
function sumArray(sumArr) { //eslint-disable-line
  ...
  for (var i = 0 ; i < sumArr.length ; i++) {
    ...
    answer4[0] = sum(answer4[0] , sumArr[i])[0];
  }

  answer4.push(sumArr[0] + ',' + sumArr[1] + ',' + sumArr[2] + ' was passed in as an array of numbers, and ' + answer4[0] + ' is their sum.');
...
function multiplyArray(multArr) { //eslint-disable-line
  ...
  var answer5 = [multArr[0]];

  for (var i = 1 ; i < multArr.length ; i++) {

    answer5[0] = multiply(answer5[0] , multArr[i])[0];
  }
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
  ...
  var answer6 = [dynamicArray[0]];
  var dynamicString = dynamicArray[0];

  for (var i = 1 ; i < dynamicArray.length ; i++) {

    answer6[0] = multiply(answer6[0] , dynamicArray[i])[0];
